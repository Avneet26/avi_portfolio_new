...
export default function Education() {
  return (
    <section id="education" className="relative border-b bg-cyber-b overflow-hidden" style={{ borderColor: "var(--color-ink)" }} aria-label="Education">
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10 py-20 lg:py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {education.map((e, i) => (
            <article key={i} className="border-2 border-ink p-6 bg-paper hover:bg-cyan-100/40 transition-colors">
